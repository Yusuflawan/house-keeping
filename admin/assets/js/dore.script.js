    ...
    o.data("checkAll") &&
      ...
      o.on("click", t.items, function (e) {
        $(e.target).is("a") ||
          ...
          ($(e.target).is("input[type='checkbox']") && (e.preventDefault(), e.stopPropagation()), s($(this).find("input[type='checkbox']")[0], e.shiftKey));
      }),
      (a.update = function () {
        r = o.find("input[type='checkbox']");
      }),
  ...
  ($.dore = function (e, t) {
    ...
    !(function () {
      (Ce = Ce || {}),
        ...
        "undefined" != typeof Storage && (localStorage.getItem("dore-direction") && (o = localStorage.getItem("dore-direction")), (i = "rtl" == o && !0));
        ...
        $(".chat-app .scroll").length > 0 && me && ($(".chat-app .scroll").scrollTop($(".chat-app .scroll").prop("scrollHeight")), me.update()),
          e < 768
            ...
            ? ($("#app-container").removeClass("menu-mobile"),
              $("#app-container").hasClass("menu-default") && ($("#app-container").removeClass(k), $("#app-container").addClass("menu-default menu-sub-hidden")))
            : ($("#app-container").removeClass("menu-mobile"),
              $("#app-container").hasClass("menu-default") && $("#app-container").hasClass("menu-sub-hidden") && $("#app-container").removeClass("menu-sub-hidden")),
          x(0, !0);
      }
      function w() {
      ...
      $(window).on("resize", function (e) {
        ...
        $(".search .search-icon").on("click", function () {
          $(window).outerWidth() < 768
            ? $(".search").hasClass("mobile-view")
              ? ($(".search").removeClass("mobile-view"), w())
              : ($(".search").addClass("mobile-view"), $(".search input").focus())
            : w();
        }),
        ...
        $(document).on("click", function (e) {
          if (!($(e.target).parents().hasClass("menu-button") || $(e.target).hasClass("menu-button") || $(e.target).parents().hasClass("sidebar") || $(e.target).hasClass("sidebar"))) {
            ...
            if ($("#app-container").hasClass("menu-sub-hidden") && 3 == v) x(S() == W ? 2 : 0);
              ...
              (($("#app-container").hasClass("menu-main-hidden") && $("#app-container").hasClass("menu-mobile")) ||
      ...
      if (
        (T($(".main-menu ul li.active a").attr("href")),
        $(".app-menu-button").on("click", function (e) {
          e.preventDefault(), $(".app-menu").hasClass("shown") ? $(".app-menu").removeClass("shown") : $(".app-menu").addClass("shown");
        }),
        $(document).on("click", function (e) {
          $(e.target).parents().hasClass("app-menu") ||
            $(e.target).parents().hasClass("app-menu-button") ||
            $(e.target).hasClass("app-menu-button") ||
            $(e.target).hasClass("app-menu") ||
            ($(".app-menu").hasClass("shown") && $(".app-menu").removeClass("shown"));
        }),
        ...
        var z = { backgroundColor: f, titleFontColor: g, borderColor: b, borderWidth: 0.5, bodyFontColor: g, bodySpacing: 10, xPadding: 15, yPadding: 15, cornerRadius: 0.15, displayColors: !1 };
        if (document.getElementById("visitChartFull")) {
          ...
          new Chart(D, {
            ...
            options: {
              layout: { padding: { left: 0, right: 0, top: 40, bottom: 0 } },
              plugins: {
                datalabels: {
              ...
              legend: { display: !1 },
              tooltips: z,
              scales: { yAxes: [{ ticks: { min: 0 }, display: !1 }], xAxes: [{ ticks: { min: 0 }, display: !1 }] },
            },
          });
        }
        if (document.getElementById("visitChart")) {
          ...
          new Chart(I, {
            ...
            options: {
              ...
              maintainAspectRatio: !1,
              scales: {
                yAxes: [{ gridLines: { display: !0, lineWidth: 1, color: "rgba(0,0,0,0.1)", drawBorder: !1 }, ticks: { beginAtZero: !0, stepSize: 5, min: 50, max: 70, padding: 0 } }],
        ...
        var R = {
            ...
            scales: { yAxes: [{ ticks: { beginAtZero: !0 }, display: !1 }], xAxes: [{ display: !1 }] },
          },
          L = {
        ...
        if (document.getElementById("salesChart")) {
          ...
          new Chart(_, {
            ...
            options: {
              ...
              maintainAspectRatio: !1,
              scales: {
                yAxes: [{ gridLines: { display: !0, lineWidth: 1, color: "rgba(0,0,0,0.1)", drawBorder: !1 }, ticks: { beginAtZero: !0, stepSize: 5, min: 50, max: 70, padding: 20 } }],
                xAxes: [{ gridLines: { display: !1 } }],
              },
              legend: { display: !1 },
              tooltips: z,
        ...
        if (document.getElementById("scatterChart")) {
          ...
          new Chart(O, {
            ...
            options: {
              ...
              maintainAspectRatio: !1,
              scales: {
                yAxes: [{ gridLines: { display: !0, lineWidth: 1, color: "rgba(0,0,0,0.1)", drawBorder: !1 }, ticks: { beginAtZero: !0, stepSize: 20, min: -80, max: 80, padding: 20 } }],
                xAxes: [{ gridLines: { display: !0, lineWidth: 1, color: "rgba(0,0,0,0.1)" } }],
              },
              legend: { position: "bottom", labels: { padding: 30, usePointStyle: !0, fontSize: 12 } },
              tooltips: z,
            },
            data: {
              datasets: [
        ...
        if (document.getElementById("radarChartNoShadow")) {
          ...
          new Chart(Z, {
            ...
            options: {
              ...
              responsive: !0,
              maintainAspectRatio: !1,
              scale: { ticks: { display: !1 } },
              legend: { position: "bottom", labels: { padding: 30, usePointStyle: !0, fontSize: 12 } },
              tooltips: z,
            },
            data: {
              datasets: [
                { label: "Stock", borderWidth: 2, pointBackgroundColor: t, borderColor: t, backgroundColor: c, data: [80, 90, 70] },
                { label: "Order", borderWidth: 2, pointBackgroundColor: r, borderColor: r, backgroundColor: p, data: [68, 80, 95] },
              ],
        ...
        if (document.getElementById("polarChart")) {
          ...
          new Chart(Y, {
            ...
            data: {
              datasets: [{ label: "Stock", borderWidth: 2, pointBackgroundColor: t, borderColor: [t, r, s], backgroundColor: [c, p, u], data: [80, 90, 50] }],
              labels: ["Cakes", "Desserts", "Cupcakes"],
            },
          });
        }
        if (document.getElementById("polarChartNoShadow")) {
          ...
          new Chart(G, {
            ...
            data: {
              datasets: [{ label: "Stock", borderWidth: 2, pointBackgroundColor: t, borderColor: [t, r, s], backgroundColor: [c, p, u], data: [80, 90, 70] }],
              labels: ["Cakes", "Desserts", "Cupcakes"],
            },
          });
        }
        ...
        if (document.getElementById("productChart")) {
          ...
          new Chart(j, {
            ...
            options: {
              ...
              maintainAspectRatio: !1,
              scales: {
                yAxes: [{ gridLines: { display: !0, lineWidth: 1, color: "rgba(0,0,0,0.1)", drawBorder: !1 }, ticks: { beginAtZero: !0, stepSize: 100, min: 300, max: 800, padding: 20 } }],
                xAxes: [{ gridLines: { display: !1 } }],
              },
              legend: { position: "bottom", labels: { padding: 30, usePointStyle: !0, fontSize: 12 } },
              tooltips: z,
            ...
            data: {
              ...
              datasets: [
                { label: "Cakes", borderColor: t, backgroundColor: c, data: [456, 479, 324, 569, 702, 600], borderWidth: 2 },
                { label: "Desserts", borderColor: r, backgroundColor: p, data: [364, 504, 605, 400, 345, 320], borderWidth: 2 },
              ],
            },
          });
        }
        ...
        var ee = {
          ...
          beforeDraw: function (e) {
            ...
            (d = e.legend.legendItems[0].hidden ? 0 : d),
              e.pointAvailable &&
                ((o = e.data.labels[e.pointIndex]),
                (i = e.data.datasets[e.pointDataIndex].data[e.pointIndex]),
                (l = (s = (r = e.data.datasets[e.pointDataIndex])._meta[Object.keys(r._meta)[0]]).total),
                (d = parseFloat(((i / l) * 100).toFixed(1))),
                (d = e.legend.legendItems[e.pointIndex].hidden ? 0 : d)),
              (n.font = "36px Nunito, sans-serif"),
              (n.fillStyle = g),
        ...
        if (document.getElementById("pieChartNoShadow")) {
          ...
          new Chart(ne, {
            type: "pie",
            data: { labels: ["Cakes", "Cupcakes", "Desserts"], datasets: [{ label: "", borderColor: [t, r, s], backgroundColor: [c, p, u], borderWidth: 2, data: [15, 25, 20] }] },
            draw: function () {},
            options: {
              plugins: { datalabels: { display: !1 } },
              responsive: !0,
        ...
        if (document.getElementById("pieChart"))
          (ne = document.getElementById("pieChart")),
            new Chart(ne, {
              type: "PieWithShadow",
              data: { labels: ["Cakes", "Cupcakes", "Desserts"], datasets: [{ label: "", borderColor: [t, r, s], backgroundColor: [c, p, u], borderWidth: 2, data: [15, 25, 20] }] },
              draw: function () {},
        ...
        if (document.getElementById("frequencyChart")) {
          ...
          new Chart(oe, {
            plugins: [ee],
            type: "DoughnutWithShadow",
            data: { labels: ["Adding", "Editing", "Deleting"], datasets: [{ label: "", borderColor: [t, r, s], backgroundColor: [c, p, u], borderWidth: 2, data: [15, 25, 20] }] },
            draw: function () {},
            options: {
              plugins: { datalabels: { display: !1 } },
              responsive: !0,
        ...
        if (document.getElementById("ageChart")) {
          ...
          new Chart(ie, {
            ...
            data: {
              ...
              datasets: [{ label: "", borderColor: [t, r, s, l, d], backgroundColor: [c, p, u, h, m], borderWidth: 2, data: [15, 25, 20, 30, 14] }],
            },
            draw: function () {},
            options: {
              plugins: { datalabels: { display: !1 } },
        ...
        if (document.getElementById("genderChart")) {
          ...
          new Chart(re, {
            plugins: [ee],
            type: "DoughnutWithShadow",
            data: { labels: ["Male", "Female", "Other"], datasets: [{ label: "", borderColor: [t, r, s], backgroundColor: [c, p, u], borderWidth: 2, data: [85, 45, 20] }] },
            draw: function () {},
            options: {
              plugins: { datalabels: { display: !1 } },
              responsive: !0,
        ...
        if (document.getElementById("workChart")) {
          ...
          new Chart(se, {
            ...
            data: {
              ...
              datasets: [{ label: "", borderColor: [t, r, s, l], backgroundColor: [c, p, u, h], borderWidth: 2, data: [15, 25, 20, 8] }],
            },
            draw: function () {},
            options: {
              plugins: { datalabels: { display: !1 } },
        ...
        if (document.getElementById("codingChart")) {
          ...
          new Chart(le, {
            ...
            data: {
              ...
              datasets: [{ label: "", borderColor: [t, r, s, l, d], backgroundColor: [c, p, u, h, m], borderWidth: 2, data: [15, 25, 20, 8, 25] }],
            },
            draw: function () {},
            options: {
              plugins: { datalabels: { display: !1 } },
      ...
      if ($().fullCalendar) {
        ...
        $(".calendar").fullCalendar({
          ...
          bootstrapFontAwesome: { prev: " simple-icon-arrow-left", next: " simple-icon-arrow-right", prevYear: " simple-icon-control-start", nextYear: " simple-icon-control-end" },
          events: [
      ...
      if ($().DataTable) {
        $(".data-table-standard").DataTable({
          ...
          pageLength: 6,
          language: { paginate: { previous: "<i class='simple-icon-arrow-left'></i>", next: "<i class='simple-icon-arrow-right'></i>" } },
          ...
          $(".data-table-scrollable").DataTable({
            ...
            fnInitComplete: function () {
              new PerfectScrollbar(".dataTables_scrollBody", { suppressScrollX: !0 }).isRtl = !1;
            },
          ...
          $(".data-table-feature").DataTable({
            ...
            language: {
              paginate: { previous: "<i class='simple-icon-arrow-left'></i>", next: "<i class='simple-icon-arrow-right'></i>" },
              search: "_INPUT_",
        ...
        var ce = $("#datatableRows").DataTable({
          ...
          sDom: '<"row view-filter"<"col-sm-12"<"float-left"l><"float-right"f><"clearfix">>>t<"row view-pager"<"col-sm-12"<"text-center"ip>>>',
          pageLength: 10,
          columns: [{ data: "Name" }, { data: "Sales" }, { data: "Stock" }, { data: "Category" }, { data: "Check" }],
          language: { paginate: { previous: "<i class='simple-icon-arrow-left'></i>", next: "<i class='simple-icon-arrow-right'></i>" } },
          drawCallback: function () {
            pe(),
              $("#checkAllDataTables").prop("checked", !1),
              $("#checkAllDataTables").prop("indeterminate", !1).trigger("change"),
              $($(".dataTables_wrapper .pagination li:first-of-type")).find("a").addClass("prev"),
              $($(".dataTables_wrapper .pagination li:last-of-type")).find("a").addClass("next"),
              $(".dataTables_wrapper .pagination").addClass("pagination-sm");
        ...
        $("#dataTablesCopy").on("click", function (e) {
          ...
          $("#checkAllDataTables").on("click", function (e) {
            $("#checkAllDataTables").prop("checked")
              ? ($("#datatableRows tbody tr").addClass("selected"), $("#datatableRows tbody tr .custom-checkbox input").prop("checked", !0).trigger("change"))
              : pe();
          }),
        ...
        $("#rightModal").on("shown.bs.modal", function (e) {
          $("#addToDatatableForm").validate({ rules: { Sales: { required: !0, number: !0, min: 3e3 }, Stock: { required: !0, number: !0 }, Category: { required: !0 }, Name: { required: !0 } } });
        }),
          $("#addToDatatable").on("click", function (e) {
            if ($("#addToDatatableForm").valid()) {
              ...
              t.each(function () {
                ...
                ce.row.add(a).draw(),
                setTimeout(function () {
                  ue.showSuccess(!0, "New row added!"),
                    setTimeout(function () {
                      $("#rightModal").modal("toggle"),
                        ...
                        $("#addToDatatableForm").find("select").data("select2") && $("#addToDatatableForm").find("select").val("").trigger("change"),
            ...
            crop: function (e) {
              ...
              fe(be, function (e) {
                var o = e.getElementsByTagName("img").item(0),
                  ...
                  s = t.width / i;
                (e.style.height = r + "px"),
                  o && ((o.style.width = a.naturalWidth / s + "px"), (o.style.height = a.naturalHeight / s + "px"), (o.style.marginLeft = -t.x / s + "px"), (o.style.marginTop = -t.y / s + "px"));
              });
            },
            zoom: function (e) {},
          };
      ...
      if (
        ...
        $("#fullScreenButton").on("click", function (e) {
          ...
          e.preventDefault(),
            xe()
              ? ($($(this).find("i")[1]).css("display", "none"), $($(this).find("i")[0]).css("display", "inline"))
              : ($($(this).find("i")[1]).css("display", "inline"), $($(this).find("i")[0]).css("display", "none")),
            (t = xe()),
      ...
      if (
        ...
        $().contextMenu &&
          $.contextMenu({
            ...
            items: {
              copy: { name: "Copy", className: "simple-icon-docs" },
        ...
        if ($(".glide.details").length > 0) {
          var Te = $(".glide.thumbs li").length,
            ...
            ze = new Glide(".glide.thumbs", {
              ...
              startAt: 0,
              direction: o,
              breakpoints: { 576: { perView: Math.min(4, Te) }, 420: { perView: Math.min(3, Te) } },
            });
          function De(e) {
        ...
        if (
          ($(".glide.dashboard-numbers").length > 0 &&
            new Glide(".glide.dashboard-numbers", {
              ...
              direction: o,
              gap: 7,
              breakpoints: { 1800: { perView: 3 }, 576: { perView: 2 }, 320: { perView: 1 } },
            }).mount(),
          $(".best-rated-items").length > 0 &&
            new Glide(".best-rated-items", {
              ...
              breakpoints: { 480: { perView: 1 }, 992: { perView: 2 }, 1200: { perView: 1 } },
            }).mount(),
          ...
          $(".glide.center").length > 0 &&
            new Glide(".glide.center", { gap: 0, type: "carousel", perView: 4, direction: o, peek: { before: 50, after: 50 }, breakpoints: { 600: { perView: 1 }, 1e3: { perView: 2 } } }).mount(),
                ...
                $(e)
                  ...
                  .each(function () {
                    $(this).find(".custom-control input").parents(".form-group").removeClass("is-invalid"),
                      $(this).find(".custom-control input:invalid").length == $(this).find(".custom-control input").length &&
