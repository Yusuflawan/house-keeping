  ...
  <div class="menu">
    <div class="main-menu">
        ...
        <ul class="list-unstyled" id="main-nav-list">
            ...
            <li data-page="my_jobs.html">
            <a href="my_jobs.html"><i class="fas fa-calendar-check"></i> My Jobs</a>
            </li>
            <li data-page="earnings.html">
            <a href="earnings.html"><i class="fas fa-money-bill-transfer"></i> Earnings</a>
            </li>
        </ul>
        </div>
    </div>
